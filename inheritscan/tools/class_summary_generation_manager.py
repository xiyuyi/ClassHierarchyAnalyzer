...
class ClassSummary:
    ...
    def _get_summary_for_1_class(self):
        mod, class_name = self.invoke_queue.pop()
        # TODO #24 load the class summary through the summary manager
    ...
    def _update_1_classinfo(self):
        ...
        class_info = self.summary_archive_manager.update_class_summary(
            class_info, class_summary
        )
        # save out.
        self.summary_archive_manager.save_classinfo(class_info)
